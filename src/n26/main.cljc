(ns n26.main
  "Kotodama WASM entrypoint for the N26 clean-room actor (L4) — Clojure port.
  ...
  facts (`n26.<Entity>/<field>`); `*store*` is the in-memory materialization
...
(defn emit-facts
  "EAVT facts for one record: {\"n26.<Entity>/<field>\" v ...}. The datomic
...
(defn healthz [] [{:status "ok" :actor "n26-compat" :tier tier :entities entities} 200])
